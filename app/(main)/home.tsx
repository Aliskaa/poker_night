      ...
      <YStack padding="$4" gap="$4">
        ...
        <XStack gap="$3">
          <Card flex={1} bordered padding="$3" backgroundColor="$backgroundStrong">
            <TrendingUp size={20} color={userStats.netProfit < 0 ? "#ef4444" : "#4ade80"} style={{ marginBottom: 8 }} />
            <Text color="$gray11" fontSize="$2">Profit Net</Text>
            <Text color={userStats.netProfit < 0 ? "#ef4444" : "#4ade80"} fontSize="$6" fontWeight="bold">{userStats.netProfit > 0 ? "+" : ""}{userStats.netProfit}€</Text>
          </Card>

          <Card flex={1} bordered padding="$3" backgroundColor="$backgroundStrong">
            <Users size={20} color="#60a5fa" style={{ marginBottom: 8 }} />
            <Text color="$gray11" fontSize="$2">Parties Jouées</Text>
            <Text color="$color" fontSize="$6" fontWeight="bold">{userStats.gamesPlayed}</Text>
          </Card>
        </XStack>
